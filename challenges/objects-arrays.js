...
const unisWithUni = [];
   graduates.forEach(function(item) {
 if (item.university.includes("unisWithUni")) {
...
//lowCaseAnimales = zooAnimals.map(an1) => an1.animal_name.tolowerCase{}
...
const  lowPopulationAnimals = zooAnimals.filter(zooAnimals => zooAnimals.length <5);
